...
public class EnemyMover : MonoBehaviour
{
    ...
    /*float RotationProcess(Vector3 currentDir, Vector3 startPosition, Vector3 endPosition)
    {
        Vector3 finalDirection = endPosition - startPosition;
        return Vector3.SignedAngle(currentDir, finalDirection, Vector3.up);
    }*/
